            ...
            <div class="g-col-12 mt-6">
                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                    ...
                    <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                        <button class="btn btn-warning w-45 me-8 mb-4" data-bs-toggle="modal" data-bs-target="#modal-tambah" id="tambah"> <i data-feather="rewind" class="w-4 h-4 me-2"></i> Tambah</button>
                ...
                <div class="intro-y overflow-auto overflow-lg-visible mt-8 mt-sm-0">
                    <table class="table table-bordered display" id="tabel-pengeluaran" width="100%" cellspacing="0">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                <div class="g-col-12">
                    <label for="pos-form-1" class="form-label">Keterangan Pengeluaran</label>
                ...
                <div class="g-col-12">
                    ...
                    <input type="file" class="form-control flex-1" id="foto_pengeluaran" name="foto_pengeluaran">
                </div>
...
<div id="modal-edit" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" id="edit-pengeluaran">
                @csrf
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                <div class="g-col-12">
                    <label for="pos-form-1" class="form-label">Keterangan Pengeluaran</label>
                ...
                <div class="g-col-12">
                    <label for="pos-form-4" class="form-label">Foto Bukti</label>
                    <input type="file" class="form-control flex-1" id="editfoto_pengeluaran" name="editfoto_pengeluaran">
                </div>
            </div>
            <!-- END: Modal Body -->
            <!-- BEGIN: Modal Footer -->
            <div class="modal-footer text-end">
                <button type="button" data-bs-dismiss="modal" class="btn btn-outline-secondary w-32 me-1" id="editcencel">Cancel</button>
...
<script>
    ...
    // function edit() {
    //     let id_edit  = $("#id").val()
    //     let url_edit = "{{ route('pengeluaran.update',':id') }}"
    ...
    $('#edit-pengeluaran').on('submit',(function(e) {
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
