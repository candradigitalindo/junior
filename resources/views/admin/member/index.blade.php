            ...
            <div class="g-col-12 mt-6">
                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                    ...
                    <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                        <button class="btn btn-primary w-40 me-8 mb-4" data-bs-toggle="modal" data-bs-target="#modal-tambah" id="tambah"> <i data-feather="plus-circle" class="w-4 h-4 me-2"></i> Tambah Member </button>
                    </div>
                </div>
                <br>
                <div class="intro-y overflow-auto overflow-lg-visible mt-8 mt-sm-0">
                    <table class="table table-bordered display" id="tabel-member" width="100%" cellspacing="0">
                        <thead>
                            <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                <div class="g-col-12">
                    ...
                    <input  type="text" class="form-control flex-1" placeholder="BK XXXX XXX" id="no_plat">
                </div>
                <div class="g-col-12">
                ...
                <div class="g-col-12">
                    <label for="pos-form-3" class="form-label">Nama Pemilik</label>
...
<script>
    ...
    $(document).on('click','.edit', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                $('#no_plat').val(res.data.no_plat)
                $('#tipe_mobil').val(res.data.tipe_mobil)
    ...
    function edit() {
        let id_edit  = $("#id").val()
        let url_edit = "{{ route('member.update',':id') }}"
