            ...
            <div class="g-col-12 mt-6">
                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                    ...
                    <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                        <button class="btn btn-primary w-45 me-8 mb-4" data-bs-toggle="modal" data-bs-target="#modal-tambah" id="tambah"> <i data-feather="plus-circle" class="w-4 h-4 me-2"></i> Tambah Tipe Mobil </button>
                    </div>
                </div>
                <br>
                <div class="intro-y overflow-auto overflow-lg-visible mt-8 mt-sm-0">
                    <table class="table table-bordered display" id="tabel-tipe" width="100%" cellspacing="0">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="g-col-12">
                        <label for="pos-form-5" class="form-label">Tipe Mobil</label>
                        <input name="name" type="text" class="form-control flex-1" id="name">
                    </div>
...
<script>
        ...
        $.ajax({
            ...
            success : function (res) {
                if($.isEmptyObject(res.error)){
                    $('#cencel').click()
                    $('#tabel-tipe').DataTable().ajax.reload()
                    swal(res.text, {
                        icon: "success",
                    });
                }else{
    ...
    $(document).on('click','.delete', function () {
        ...
        .then((willDelete) => {
            if (willDelete) {
                let id  = $(this).attr('id')
                let url = "{{ route('tipemobil.destroy',':id') }}"
